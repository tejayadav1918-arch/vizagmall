...
import { tradproducts } from './Offertraditional'; // Adjust the import path as necessary
// Importing products from Restaurant1.js
import './ProductPage.css'; // We'll add sticky styles here
import CartButton from "../components/CartButton";

const OfferProductPage4 = () => {
  const { id } = useParams();
  const product = tradproducts.find((p) => p.id === parseInt(id));
...
export default OfferProductPage4;