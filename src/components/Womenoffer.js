...
import { womoffproducts } from './Offerwomen'; // Adjust the import path as necessary
// Importing products from Restaurant1.js
import './ProductPage.css'; // We'll add sticky styles here
import CartButton from "../components/CartButton";

const OfferProductPage5 = () => {
  const { id } = useParams();
  const product = womoffproducts.find((p) => p.id === parseInt(id));
...
export default OfferProductPage5;