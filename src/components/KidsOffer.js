...
import { offerproducts1 } from './Offerkids'; // Adjust the import path as necessary
// Importing products from Restaurant1.js
import './ProductPage.css'; // We'll add sticky styles here
import CartButton from "../components/CartButton";

const OfferProductPage1 = () => {
  const { id } = useParams();
  const product = offerproducts1.find((p) => p.id === parseInt(id));
...
export default OfferProductPage1;